...
def f_tartaruga(tartaruga:int, tartaruga_energia:int, traguardo:int):
    
#INIT
    dado: int = random.randint(1, 10)
    tartarugadep:int = tartaruga
...
#RETURN
    return tartaruga, tartaruga_energia


def f_lepre (lepre:int, lepre_energia:int, traguardo:int):
...
#BODY
    ...
    if lepre > traguardo:
        lepre = lepredep
#RETURN
    return lepre, lepre_energia

def posizioni():

#INIT
    percorso:list = ["*"] * 70
    traguardo:int = len (percorso)-1
    
    tartaruga: int = 1
    lepre: int = 1
    
    cont:int = 0
    tartaruga_energia:int = 100
    lepre_energia:int = 100
...
#BODY
    ...
    while lepre < traguardo and tartaruga < traguardo:
        ...
        lepre, lepre_energia = f_lepre(lepre, lepre_energia, traguardo)

        tartaruga, tartaruga_energia = f_tartaruga(tartaruga, tartaruga_energia, traguardo)
