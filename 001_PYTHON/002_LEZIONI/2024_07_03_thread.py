...
if __name__ == "__main__":
    ...
    #map prende ogni elemento a destra in un range di 100 elementi. il primo elemento lo usa come argoemnto della funzione e poi gli altri, fino ad arrovare a 10 thread
    #ho 100 task ma solo 10 thread che possano eseguirli
