...
# L'INTESTAZIONE NON E' CHIARAMENTE INDICATA IN QUANTO
# VIENE CHIESTO IN TEORIA DI TROVARE IL LASSO DI TEMPO 
# TRA I DUE ORARI E DOVREBBE ESSERE COSI
#    if time1 <= time2:
#        return (time2 - time1)
#    else:
#        return  (24*3600 - time1) + time2
