...
/*chiedi all'utente 
    se vuole inserire un altro numero
    se il numero va inserito nella variabile B
    se non viene specificato è stringa resta una int
*/

/*
var A = 20
var B = 10
resp = prompt("Vuoi inserire un numero (si/no)?")
if(resp=="si")
{
...
let vocali = "aeiouAEIUO"
var parola = prompt ("inserisci una parola qualunque")
...
{ 
    ...
    console.log("le vocali sono" + countvocale)
    console.log("le consontanti sono" + countconsonante)
    parola = prompt ("inserisci una parola qualunque")
}
